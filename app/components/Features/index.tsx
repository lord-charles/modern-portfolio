        ...
        <div className="grid lg:grid-cols-2 gap-x-4 gap-y-4">
          ...
          <div>
            ...
            <p className="lg:text-lg font-normal text-bluish text-center md:text-start">
              In software development, I&apos;m your catalyst for
              transformation, creating elegant, efficient solutions that exceed
              expectations. Choose me as your developer, and let&apos;s make
              dreams a reality.
            </p>
          </div>
          {/* Column-2 */}
