              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16 ">
                  ...
                  <p className="text-xl text-bluish mb-4 text-start ">
                    Next.js holds a special place in my arsenal of tools for web
                    development. This cutting-edge framework has been a
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <p className="text-xl text-bluish mb-4 ">
                    ...
                    pivotal role in my projects. Here&apos;s why React is a top
                    choice for crafting exceptional digital experiences:
                  </p>
                  <ul className="text-lg text-bluish -mb-2">
                    <li className="flex items-center mb-2 ">
                      <svg
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-bluish mb-4">
                    React Native, a game-changer in mobile app development, is a
                    key component of my toolkit. Here&apos;s why I choose React
                    Native for crafting exceptional mobile applications:
                  </p>
                  <ul className="text-lg text-bluish -mb-2">
                    <li className="flex items-center mb-2 ">
                      <svg
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <p className="text-xl text-bluish mb-4 ">
                    ...
                    applications, and here&apos;s why it&apos;s a cornerstone of
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-bluish mb-4">
                    Tailwind CSS is an indispensable tool in my web development
                    arsenal, offering several key advantages:
                  </p>
                  <ul className="text-lg text-bluish -mb-2">
                    <li className="flex items-center mb-2 ">
                      <svg
