                    ...
                    <div className="relative flex h-14 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex flex-shrink-0 items-center">
                                ...
                                />
                                   <Image
                                    className="h-[100px] w-[100px] object-scale-down lg:hidden"
                                      src={'/logos/logo3-removebg-preview.png'}
                                    alt="Crypto-Logo"
                                    width={200}
                                    height={200}
                            ...
                            <button className='hidden lg:flex justify-end text-xl font-semibold py-4 px-6 lg:px-12 navbutton text-white'>Contact</button>
                            {/* <Contactusform /> */}
                        </div>
                        ...
                        <div className={`block lg:hidden z-[99] ${isOpen? 'hidden':'visible'}`}>
